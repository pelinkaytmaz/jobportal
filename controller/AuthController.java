...
import com.dauphine.jobportal.dto.JwtResponse;
import com.dauphine.jobportal.dto.LoginRequest;
import com.dauphine.jobportal.dto.MessageResponse;
import com.dauphine.jobportal.dto.SignupRequest;
...
public class AuthController {
    ...
    // Ajoutez un endpoint de test pour vérifier que le contrôleur est accessible
    @PostMapping("/test")
    public ResponseEntity<?> testEndpoint() {
        return ResponseEntity.ok(new MessageResponse("Auth endpoint is accessible!"));
    }
}